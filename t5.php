...
tag = "T5_ETF^AP_T5_R6^AP_T5_R2^AP_T5_R3^AP_T5_R5^AP_T5_R4^AP_T5_R1`"
 + "T5_Return^AP_T5_R6_return^AP_T5_R2_return^AP_T5_R3_return^AP_T5_R5_return^AP_T5_R4_return^AP_T5_R1_return`"
 + "T5_SD^AP_T5_R6_risk^AP_T5_R2_risk^AP_T5_R3_risk^AP_T5_R5_risk^AP_T5_R4_risk^AP_T5_R1_risk`"
 + "T5_Range^AP_T5_R6_range^AP_T5_R2_range^AP_T5_R3_range^AP_T5_R5_range^AP_T5_R4_range^AP_T5_R1_range";

txt = "ETF Name^MSCI Australia ETF^JPX-Nikkei 400 ETF^MSCI All Country Asia ex Japan ETF^Asia/Pacific Dividend ETF^MSCI Singapore ETF^MSCI Japan Value ETF`"
 + "3-year Total Return (%)^31^23^26^30^27^21`"
 + "3-year Standard Deviation (%)^23^14^16^18^17^13`"
 + "Expected Return Range for 2025 (%)^8 ~ 54^9 ~ 37^10 ~ 42^11 ~ 48^10 ~ 44^8 ~ 34";
...
CBCol = "0^0^0^0^0^0^0";
CBRow = "0^0^0^0";
W_Col = "130^100^100^100^100^100^110";
H_Row = "50^60^60^80";

chkchoice = false;
btnFlg = 1;
btnType = "radio";
btntxt = "ETF Option^MSCI Australia ETF^JPX-Nikkei 400 ETF^MSCI All Country Asia ex Japan ETF^Asia/Pacific Dividend ETF^MSCI Singapore ETF^MSCI Japan Value ETF";
btnstate = "0^1^1^1^1^1^1";
btntag = "btn7^AP_T5_R6^AP_T5_R2^AP_T5_R3^AP_T5_R5^AP_T5_R4^AP_T5_R1";
...
//Delay: AP_T5_R2_return AP_T5_R3_return AP_T5_R5_return AP_T5_R4_return AP_T5_R1_return AP_T5_R2_risk AP_T5_R3_risk AP_T5_R5_risk AP_T5_R4_risk AP_T5_R1_risk AP_T5_R2_range AP_T5_R3_range AP_T5_R5_range AP_T5_R4_range AP_T5_R1_range
...
The company has invested a substantial chunk of its assets in the MSCI Australia ETF.

You need to decide whether to keep the assets in the MSCI Australia ETF or transfer them to another ETF.
...
<!--end cell-->
<!--cell b6(tag:AP_T5_R1_return)-->
<TD align=center valign=middle><DIV ID="b6_cont" style="position: relative; height: 60px; width: 110px;"><DIV ID="b6_txt" STYLE="position: absolute; left: 0px; top: 0px; height: 60px; width: 110px; clip: rect(0px 110px 60px 0px); z-index: 1;"><TABLE><TD ID="b6_td" align=center valign=center width=105 height=55 class="actTD">21</TD></TABLE></DIV><DIV ID="b6_box" STYLE="position: absolute; left: 0px; top: 0px; height: 60px; width: 110px; clip: rect(0px 110px 60px 0px); z-index: 2;"><TABLE><TD ID="b6_tdbox" align=center valign=center width=105 height=55 class="boxTD">3-year Total Return</TD></TABLE></DIV><DIV ID="b6_img" STYLE="position: absolute; left: 0px; top: 0px; height: 60px; width: 110px; z-index: 5;"><A HREF="javascript:void(0);" NAME="b6" onMouseOver="ShowCont('b6',event)" onMouseOut="HideCont('b6',event)"><IMG NAME="b6" SRC="transp.gif" border=0 width=110 height=60></A></DIV></DIV></TD>
<!--end cell--></TR><TR>
<!--cell c0(tag:T5_SD)-->
...
<!--end cell-->
<!--cell c6(tag:AP_T5_R1_risk)-->
<TD align=center valign=middle><DIV ID="c6_cont" style="position: relative; height: 60px; width: 110px;"><DIV ID="c6_txt" STYLE="position: absolute; left: 0px; top: 0px; height: 60px; width: 110px; clip: rect(0px 110px 60px 0px); z-index: 1;"><TABLE><TD ID="c6_td" align=center valign=center width=105 height=55 class="actTD">13</TD></TABLE></DIV><DIV ID="c6_box" STYLE="position: absolute; left: 0px; top: 0px; height: 60px; width: 110px; clip: rect(0px 110px 60px 0px); z-index: 2;"><TABLE><TD ID="c6_tdbox" align=center valign=center width=105 height=55 class="boxTD">3-year Standard Deviation</TD></TABLE></DIV><DIV ID="c6_img" STYLE="position: absolute; left: 0px; top: 0px; height: 60px; width: 110px; z-index: 5;"><A HREF="javascript:void(0);" NAME="c6" onMouseOver="ShowCont('c6',event)" onMouseOut="HideCont('c6',event)"><IMG NAME="c6" SRC="transp.gif" border=0 width=110 height=60></A></DIV></DIV></TD>
<!--end cell--></TR><TR>
<!--cell d0(tag:T5_Range)-->
