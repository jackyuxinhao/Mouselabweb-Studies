...
//
//      v 1.00c, May 2021 (php 7/8 mysqli compatible)
//
//     (c) 2004-20 Martijn C. Willemsen and Eric J. Johnson 
//
...
$sqlQuery = "SELECT * from $table where expname='".$nameofexp."'";
    ...
    # Execute SQL query 
    $result=mysqli_query($link,$sqlQuery) or die("Invalid Query 1: ".mysqli_error($link)); 
...
<?php
    ...
    # Execute SQL query 
    $result=mysqli_query($link, $sqlQuery) or die("Invalid Query 2: ".mysqli_error($link)); 
...
$sqlQuery = "SELECT DISTINCT expname from $table";
    ...
    # Execute SQL query 
    $result=mysqli_query($link,$sqlQuery) or die("Invalid Query 3: ".mysqli_error($link)); 
